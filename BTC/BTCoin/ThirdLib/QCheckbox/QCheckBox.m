...
- (id)initWithDelegate:(id)delegate {
    ...
    if (self) {
        ...
        [self setImage:[UIImage imageNamed:@"entrust_unsel"] forState:UIControlStateNormal];
        [self setImage:[UIImage imageNamed:@"entrust_sel"] forState:UIControlStateSelected];
