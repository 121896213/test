...
- (instancetype)initWithSuperView:(UIView*)superView {
    ...
    if (self = [super initWithFrame:CGRectMake(0.0, superView.frame.size.height, ScreenWidth, kHooDatePickerHeight)]) {
...
- (UIView *)headerView {
    if (!_headerView) {
        ...
        [cancelButton setTitleColor:self.highlightColor forState:UIControlStateNormal];
