...
- (instancetype)init
{
    ...
    if (self) {
        ...
        _rightBtnTitle = @"确定";
        _rightBtnBGColor = UIColorFromRGB(0x2e457b);//  CGXPickerRGBColor(252, 96, 134, 1);
        _rightBtnTitleSize = 16;
        _rightBtnTitleColor = [UIColor whiteColor];
        
        _rightBtnborderColor = LineColor;//CGXPickerRGBColor(252, 96, 134, 1);
        _rightBtnCornerRadius = 6;
        _rightBtnBorderWidth = 1;
        
        _leftBtnTitle = @"取消";
        _leftBtnBGColor =  UIColorFromRGB(0x2e457b);//CGXPickerRGBColor(252, 96, 134, 1);
        _leftBtnTitleSize = 16;
        _leftBtnTitleColor = [UIColor whiteColor];
        
        _leftBtnborderColor = LineColor;//CGXPickerRGBColor(252, 96, 134, 1);
