...
//    return TheAppDel.isKLineDarkModel ? [UIColor colorWithRGBHex:0x181c20]: [UIColor colorWithRGBHex:0xffffff];
    return TheAppDel.isKLineDarkModel ? [UIColor colorWithRGBHex:0x000000]: [UIColor colorWithRGBHex:0xffffff];
...
//    return TheAppDel.isKLineDarkModel ?[UIColor colorWithRGBHex:0x1d2227]:[UIColor colorWithRGBHex:0xffffff];
    return TheAppDel.isKLineDarkModel ?[UIColor colorWithRGBHex:0x000000]:[UIColor colorWithRGBHex:0xffffff];
...
{
//    return [UIColor colorWithRGBHex:0xff5353];
    return TheAppDel.isKLineDarkModel ? WhiteColor :[UIColor colorWithRGBHex:0x333333];
}
...
{
    return TheAppDel.isKLineDarkModel ?[UIColor whiteColor]:UIColorFromRGB(0x999999);
}
