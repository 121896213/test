...
- (void)refreshKLineModels:(NSArray *)kLineModels
{
    if(!kLineModels) {
        return;
    }
...
-(void)refreshUI{
    UIColor * color =  TheAppDel.isKLineDarkModel ? UIColorFromRGB(0x000000):WhiteColor;
    _scrollView.backgroundColor = color;
    _kLineMainView.backgroundColor = color;
    _kLineVolumeView.backgroundColor = color;
    _kLineAccessoryView.backgroundColor = color;
    _priceView.backgroundColor = color;
    _volumeView.backgroundColor = color;
    _accessoryView.backgroundColor = color;
    _kLineMAView.backgroundColor = color;
    _volumeMAView.backgroundColor = color;
   _accessoryMAView.backgroundColor = color;
    [self.kLineMAView refreshUI];
}
