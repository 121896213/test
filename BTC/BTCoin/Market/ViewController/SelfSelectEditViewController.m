//
//  SelfSelectEditViewController.m
//  BTCoin
//
...
@interface SelfSelectEditViewController (){
    UIButton * leftMenu;
}
...
@implementation SelfSelectEditViewController
...
- (UIViewController *)magicView:(VTMagicView *)magicView viewControllerAtPage:(NSUInteger)pageIndex
{
    ...
    NSString *recomId = FormatString(@"SelectEdit.identifier%lu",(unsigned long)recomIdIndex);
    SelfSelectEditSubViewController *homeSubViewController = [magicView dequeueReusablePageWithIdentifier:recomId];
    if (!homeSubViewController) {
        homeSubViewController = [[SelfSelectEditSubViewController alloc] init];
    }
