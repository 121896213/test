...
- (void)init_setup {
    ...
    _titleMargin = 0;
    _titleNormalFont  = [UIFont pingFangSCFontOfSize:14];
    _titleSelectFont  = [UIFont pingFangSCFontOfSize:14];
    ...
    _viewNormalBackgroundColor = [[UIColor blackColor] colorWithAlphaComponent:0.7];
    _viewSelectBackgroundColor = [UIColor blackColor];
...
- (void)btnClick:(SHTapButtonView *)btn isBlock:(BOOL)isRun{
    ...
    for (SHTapButtonView *btns in self.btnArray) {
        ...
        btns.viewNormalBackgroundColor=self.viewNormalBackgroundColor;
    ...
    [UIView animateWithDuration:0.05 animations:^{
        ...
        btn.viewSelectBackgroundColor=self.viewSelectBackgroundColor;
    }];
...
- (void)reloadViews {
    ...
    if (self.titleArray.count == self.btnArray.count && self.titleArray.count > 0) {
        ...
        for (NSInteger index = 0; index < self.btnArray.count; index++) {
            ...
            btn.viewSelectBackgroundColor = self.viewSelectBackgroundColor;
            btn.viewNormalBackgroundColor = self.viewNormalBackgroundColor;
            
            NSString *title = self.titleArray[index];
            
            CGFloat btnW = ceilf([title boundingRectWithSize:CGSizeMake(MAXFLOAT, 0) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:btn.titleFont} context:nil].size.width) ;
        ...
        if (CGRectGetMaxX(lastView.frame) < self.width) {
            ...
            for (NSInteger index = 0; index < self.btnArray.count; index++) {
                ...
                UIView* lineView=[[UIView alloc]initWithFrame:CGRectMake(btn.width-1, 0, 1, btn.height)];
                lineView.backgroundColor=self.viewSelectBackgroundColor;
...
- (void)setSelected:(BOOL)selected {
    ...
    self.backgroundColor=selected?self.viewSelectBackgroundColor:self.viewNormalBackgroundColor;
}
...
-(void)setViewNormalBackgroundColor:(UIColor *)viewNormalBackgroundColor{
    _viewNormalBackgroundColor=viewNormalBackgroundColor;
    self.backgroundColor=_viewNormalBackgroundColor;
}
-(void)setViewSelectBackgroundColor:(UIColor *)viewSelectBackgroundColor{
    _viewSelectBackgroundColor=viewSelectBackgroundColor;
    self.backgroundColor=_viewSelectBackgroundColor;
}
#pragma mark -
#pragma mark   ==============UI-lazy==============
- (UILabel *)titleL {
