...
- (void)addButtonWithTitle:(NSString *)title type:(JCButtonType)type clicked:(void (^)(void))clicked {
    ...
    if (type == JCButtonTypeNormal || type == JCButtonTypeCancel) {
        self.style.content.textAlignment=NSTextAlignmentCenter;
    }else {
        self.style.content.textAlignment=NSTextAlignmentLeft;
    }
